...
#define LOOK_SeparateButtonTitle_ID				(LOOK_SUPPORTED_ID_START+35)
#define LOOK_RubberBand_ID						(LOOK_SUPPORTED_ID_START+36)					  
#define LOOK_WindowStyle_ID_START				(LOOK_SUPPORTED_ID_START+37)
...
#define LOOK_WindowStyle_ID_END					(LOOK_SUPPORTED_ID_START+41)
#define LOOK_MenuStyle_ID_START					(LOOK_SUPPORTED_ID_START+41)
#define LOOK_MenuItemStyle_ID					(LOOK_SUPPORTED_ID_START+41)					  
#define LOOK_MenuTitleStyle_ID					(LOOK_SUPPORTED_ID_START+42)					  
#define LOOK_MenuHiliteStyle_ID					(LOOK_SUPPORTED_ID_START+43)					  
#define LOOK_MenuStippleStyle_ID				(LOOK_SUPPORTED_ID_START+44)					  
#define LOOK_MenuSubItemStyle_ID				(LOOK_SUPPORTED_ID_START+45)					  
#define LOOK_MenuHiTitleStyle_ID				(LOOK_SUPPORTED_ID_START+46)
#define LOOK_MenuStyle_ID_END					(LOOK_SUPPORTED_ID_START+47)		  
#define LOOK_MenuItemCompositionMethod_ID		(LOOK_SUPPORTED_ID_START+47)	  
#define LOOK_MenuHiliteCompositionMethod_ID		(LOOK_SUPPORTED_ID_START+48)
#define LOOK_MenuStippleCompositionMethod_ID	(LOOK_SUPPORTED_ID_START+49)
#define LOOK_ShadeAnimationSteps_ID				(LOOK_SUPPORTED_ID_START+50)	  
#define LOOK_TitleButtonBalloonBorderHilite_ID	(LOOK_SUPPORTED_ID_START+51)
#define LOOK_TitleButtonBalloonXOffset_ID		(LOOK_SUPPORTED_ID_START+52)
#define LOOK_TitleButtonBalloonYOffset_ID		(LOOK_SUPPORTED_ID_START+53)
#define LOOK_TitleButtonBalloonDelay_ID			(LOOK_SUPPORTED_ID_START+54)		  
#define LOOK_TitleButtonBalloonCloseDelay_ID	(LOOK_SUPPORTED_ID_START+55)
#define LOOK_TitleButtonBalloonStyle_ID			(LOOK_SUPPORTED_ID_START+56)
#define LOOK_TitleButtonBalloons_ID				(LOOK_SUPPORTED_ID_START+57)
#define LOOK_TitleButton_ID						(LOOK_SUPPORTED_ID_START+58)
#define LOOK_KillBackgroundThreshold_ID			(LOOK_SUPPORTED_ID_START+59)
#define LOOK_DontAnimateBackground_ID			(LOOK_SUPPORTED_ID_START+60)
