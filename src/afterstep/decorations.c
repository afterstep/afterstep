...
static ASCanvas *check_side_canvas (ASWindow * asw, FrameSide side,
																		Bool required)
{
...
static ASCanvas *check_frame_canvas (ASWindow * asw, Bool required)
{
...
static ASCanvas *check_client_canvas (ASWindow * asw, Bool required)
{
...
static ASCanvas *check_icon_canvas (ASWindow * asw, Bool required)
{
...
static ASCanvas *check_icon_title_canvas (ASWindow * asw, Bool required,
...
static ASTBarData *check_tbar (ASTBarData ** tbar, Bool required,
...
Bool hints2decorations (ASWindow * asw, ASHints * old_hints)
{
	...
	if (asw->icon_canvas) {
		...
		if (icon_image_changed) {
			ASImage *icon_image =
					get_client_icon_image (ASDefaultScr, asw->hints);
