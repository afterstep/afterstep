...
void
InitMiniScroll (struct XObj *xobj)
{
  unsigned long mask;
...
void
DestroyMiniScroll (struct XObj *xobj)
{
...
void
DrawMiniScroll (struct XObj *xobj)
{
...
void
EvtMouseMiniScroll (struct XObj *xobj, XButtonEvent * EvtButton)
{
  static XEvent event;
  int x1, y1, x2, y2;
  Window Win1, Win2;
...
void
EvtKeyMiniScroll (struct XObj *xobj, XKeyEvent * EvtKey)
{
}

void
ProcessMsgMiniScroll (struct XObj *xobj, unsigned long type, unsigned long *body)
{
}
