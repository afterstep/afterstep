...
void
InitHDipstick (struct XObj *xobj)
{
  unsigned long mask;
...
void
DestroyHDipstick (struct XObj *xobj)
{
...
void
DrawHDipstick (struct XObj *xobj)
{
  int i;
...
void
EvtMouseHDipstick (struct XObj *xobj, XButtonEvent * EvtButton)
{
}

void
EvtKeyHDipstick (struct XObj *xobj, XKeyEvent * EvtKey)
{
}


void
ProcessMsgHDipstick (struct XObj *xobj, unsigned long type, unsigned long *body)
{
}
